...
public class MainActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// create the camera view button
		FloatingActionButton viewCameraButton = findViewById(R.id.view_camera);
		viewCameraButton.setOnClickListener(new View.OnClickListener()
		{
			@Override
			public void onClick(View view)
			{
